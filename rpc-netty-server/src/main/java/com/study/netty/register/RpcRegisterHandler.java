...
public class RpcRegisterHandler extends ChannelInboundHandlerAdapter {
    ...
    public RpcRegisterHandler() {
        doScannerClass("com.study.netty.provider");
        doRegister();
    }
...
//        System.out.println(protocol.getClassName());
...
//                registryCenter.regist(i.getName(), InetAddress.getLocalHost().getHostAddress() + ":" + port);
